...
export const Tab: React.FC<TabProps> = ({setIsActive}) => {
    ...
    return (
      <View style={styles.container}>
        ...
        >
          <Text style={[styles.tabText, activeTab === 'voluntary' && styles.activeTab]}>Könüllü</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.tab, activeTab === 'offical' && styles.activeTab]}
          onPress={() => handleTabPress('offical')}
        >
          <Text style={[styles.tabText, activeTab === 'offical' && styles.activeTab]}>Məsul şəxs</Text>
        </TouchableOpacity>
      </View>
    );
  };
